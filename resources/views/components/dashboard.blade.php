        ...
        <div class="col-xl-12 col-md-6">
            <div class="card bg-c-orenge update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            <h4 class="text-white">Stok : {{ $stokGudangs[0]->total ?? 0 }} Barang</h4>
                            <h6 class="text-white m-b-0">Gudang N/A (Tidak Diketahui)</h6>
                        </div>
                        <div class="col-4 text-end">
                            <canvas id="update-chart-4" height="50"></canvas>
                        </div>
        ...
        <div class="col-xl-6 col-md-12">
            ...
            <div class="row m-l-0 m-r-0">
                ...
                <div class="card-block">
                    ...
                    <li>
                        <a href="#!" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-original-title="facebook"><i class="feather icon-facebook facebook')}}" aria-hidden="true"></i></a>
                    </li>
                    <li>
                        <a href="#!" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-original-title="twitter"><i class="feather icon-twitter twitter')}}" aria-hidden="true"></i></a>
                    </li>
                    <li>
                        <a href="#!" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-original-title="instagram"><i class="feather icon-instagram instagram')}}" aria-hidden="true"></i></a>
                    </li>
                    </ul>
                </div>
                </div>
