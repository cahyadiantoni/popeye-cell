                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="{{ route('transaksi-jual-outlet.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="kode_faktur" class="form-select form-control">
                                                ...
                                                <option value="O-JK" {{ $gudangId == 8 ? 'selected' : '' }}>O-JK - Joko Cell</option>
                                                <option value="O-AD" {{ $gudangId == 9 ? 'selected' : '' }}>O-AD - Adit Cell</option>
                                                <option value="O-PY" {{ $gudangId == 10 ? 'selected' : '' }}>O-PY - Popeye Cell</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('transaksi-jual-outlet.index') }}" class="btn btn-secondary btn-round">List All Transaksi</a>
        ...
        $(document).ready(function() {
            function updateNomorFaktur() {
                ...
                if (kodeFaktur && tglJual) {
                    $.ajax({
                        url: "{{ route('suggest.no.fak.outlet') }}",
                        type: "GET",
