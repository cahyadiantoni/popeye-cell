            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @forelse($kesimpulan->payments->sortByDesc('created_at') as $payment)
                            @php
        ...
        <div class="modal-content">
            <form id="payment-form"> @csrf
                ...
                <div class="modal-body">
                    ...
                    {{-- =================== BAGIAN WAJIB DIUBAH =================== --}}
                    <input type="hidden" name="paymentable_id" value="{{ $kesimpulan->id }}">
                    <input type="hidden" name="paymentable_type" value="kesimpulan_bawah">
                    {{-- ========================================================== --}}
...
<script>
    ...
    // Script untuk format nominal di modal pembayaran baru
