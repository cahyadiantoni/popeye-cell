...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            <div class="d-inline">
                                <h4>List Data Barang Pendingan</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('data-barang-pendingan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <a href="{{ asset('files/template pendingan barang.xlsx') }}" class="text-primary" target="_blank">Download Template Excel</a>
                        </div>
...
<script>
    $(document).ready(function () {
        $('#tablebarang').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('data-barang-pendingan.index') }}", // Pastikan rute ini mengarah ke metode `index` di controller
            columns: [
