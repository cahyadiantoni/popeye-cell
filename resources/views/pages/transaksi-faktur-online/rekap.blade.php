...
@section('title', 'Rekap Transaksi Online')
@section('content')
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item" style="float: left;"><a href="#!">Rekap Transaksi Online</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            {{-- Form Filter --}}
                            <form method="GET" action="{{ route('transaksi-faktur-online.rekap') }}">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('transaksi-faktur-online.rekap') }}" class="btn btn-secondary ml-2">Reset</a>
                                    </div>
                                </div>
                            </form>
